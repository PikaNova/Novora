...
type Props = { kind: 'major' | 'weekly'; context: string; targetTitle?: string };

export default function AiImportGuide({ kind, context, targetTitle = '' }: Props) {
