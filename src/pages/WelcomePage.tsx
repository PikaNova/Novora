...
export default function WelcomePage() {
  ...
  const [classTags, setClassTags] = useState<string[]>(() => { const exam = getAppSettings().exam; return collectClassTags(exam.weeklyPlans, exam.majors, exam.activeWeeklyPlanIdByClass); });
